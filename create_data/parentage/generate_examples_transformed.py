...
def print_numbers(num_sentences,len_names,num_examples=0):
	...
	print ("\n#Total possible generated examples: "+str((3*len_names*(len_names-1)*(len_names-2))))
	if num_examples!=0:
...
def generate(num_sentences,names,num_examples):
	...
	while cnt_1 < int(num_examples/3)-1000:
		...
		for rel in [0,1,2]:
			...
			if rel==0:
				...
				if temp_example not in examples and cnt_0<int(num_examples/3)-1000:
					cnt_0+=1
			...
			if rel==1:
				...
				if temp_example not in examples and cnt_1<int(num_examples/3)-1000:
					cnt_1+=1
					fo.write(temp_example+'\n')
					examples.append(temp_example)
					examples_transformed.append(temp_example_transformed)
			...
			if rel==2:
				...
				if temp_example not in examples and cnt_2<int(num_examples/3)-1000:
					cnt_2+=1
					fo.write(temp_example+'\n')
					examples.append(temp_example)
					examples_transformed.append(temp_example_transformed)
