...
def confirm_numbers(num_sentences,len_names,len_locs,len_verbs):
	...
	while True:
		...
		if ans1.lower()=='y':
			...
			cnt_names = raw_input(str(len_names)+" names available. How many do you want to use? Type 0 to use all. ") 
			...
			cnt_locs = raw_input(str(len_locs)+" locations available. How many do you want to use? Type 0 to use all. ") 
			...
			cnt_verbs = raw_input(str(len_verbs)+" verbs available. How many do you want to use? Type 0 to use all. ") 
		...
		if ans2.lower()=='y':
			ne=int(raw_input("How many examples?[1-"+str(num_examples)+"] "))
			if(ne>num_examples):
